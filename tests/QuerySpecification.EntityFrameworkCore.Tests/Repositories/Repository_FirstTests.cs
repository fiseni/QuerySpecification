...
public class Repository_FirstTests(TestFactory factory) : IntegrationTest(factory)
{
    ...
    [Fact]
    public async Task FirstAsync_ReturnsFirstItem_GivenEntityExists()
    {
        ...
        var result = await repo.FirstAsync(spec);
    ...
    [Fact]
    public async Task FirstAsync_ThrowsEntityNotFoundException_GivenEntityNotExists()
    {
        var expected = new Country { Name = "b" };
        ...
        var result = () => repo.FirstAsync(spec);

        await result.Should().ThrowAsync<EntityNotFoundException>();
    }

    [Fact]
    public async Task FirstAsync_ReturnsFirstItem_GivenProjectionAndEntityExists()
    {
    ...
    [Fact]
    public async Task FirstAsync_ThrowsEntityNotFoundException_GivenProjectionAndEntityNotExists()
    {
        var expected = new CountryDto("b");
    ...
    public async Task FindAsync_ReturnsFirstItem_GivenIdExists()
    {
        ...
        var result = await repo.FindAsync(expected.Id);
    ...
    public async Task FindAsync_ReturnsNull_GivenIdNotExists()
    {
        ...
        var result = await repo.FindAsync(99);
