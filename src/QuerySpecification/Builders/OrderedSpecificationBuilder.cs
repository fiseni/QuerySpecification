...
internal sealed class OrderedSpecificationBuilder<T, TResult> : IOrderedSpecificationBuilder<T, TResult>
{
...
internal sealed class OrderedSpecificationBuilder<T> : IOrderedSpecificationBuilder<T>
{
